...
bia_baseline_all <- summarize_numerical(bia_baseline, "sex")
bia_baseline_groups <- summarize_numerical(bia_baseline, "allocation_group") #groups
bia_baseline_compare <- compare_groups(bia_baseline) # compare
print(bia_baseline_compare) # print
```
