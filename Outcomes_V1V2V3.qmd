...
```{r labs_cholesterol_distribution_1}
ggplot(
    data = data_model, 
    aes(
        x = as.factor(visit),
...
```{r labs_cholesterol_distribution_2}
data_model %>% 
    filter(
...
```{r labs_triglycerides_distribution_1}
ggplot(
    data = data_model, 
    aes(
        x = as.factor(visit),
...
```{r labs_triglycerides_distribution_2}
data_model %>% 
    filter(
...
```{r labs_quick_index_distribution_1}
ggplot(
    data = data_model, 
    aes(
        x = as.factor(visit),
...
```{r labs_quick_index_distribution_2}
data_model %>% 
    filter(
