...
#### Médias Marginais Estimadas \##### Todos os dados
...
# LMM
whoqol_score_overall_model <- lmer(whoqol_score_overall ~ allocation_group * visit + 
(1 | record_id), data = data_model_V1V3)
...
# Pairwise comparisons: Between groups at each visit
emmeans::contrast(whoqol_score_overall_raw_emm,
method = "pairwise", by = "visit",
adjust = "bonferroni") %>% summary(infer = c(TRUE, TRUE))
...
# Pairwise comparisons: Between groups at each visit
emmeans::contrast(whoqol_score_overall_emm,
method = "pairwise", by = "visit",
adjust = "bonferroni") %>% summary(infer = c(TRUE, TRUE))
...
# LMM
dass_score_depression_model <- lmer(dass_score_depression ~ allocation_group * visit + 
(1 | record_id), data = data_model_V1V3)
...
# Pairwise comparisons: Between groups at each visit
emmeans::contrast(dass_score_depression_raw_emm,
method = "pairwise", by = "visit",
adjust = "bonferroni") %>% summary(infer = c(TRUE, TRUE))
...
# Pairwise comparisons: Between groups at each visit
emmeans::contrast(dass_score_depression_emm,
method = "pairwise", by = "visit",
adjust = "bonferroni") %>% summary(infer = c(TRUE, TRUE))
...
# LMM
dass_score_stress_model <- lmer(dass_score_stress ~ allocation_group * visit + 
(1 | record_id), data = data_model_V1V3)
...
# Pairwise comparisons: Between groups at each visit
emmeans::contrast(dass_score_stress_raw_emm,
method = "pairwise", by = "visit",
adjust = "bonferroni") %>% summary(infer = c(TRUE, TRUE))
...
# Pairwise comparisons: Between groups at each visit
emmeans::contrast(dass_score_stress_emm,
method = "pairwise", by = "visit",
adjust = "bonferroni") %>% summary(infer = c(TRUE, TRUE))
