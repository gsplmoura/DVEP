...
- .my-coral[**Atividade Anti-inflamatória**]
  - inibe quinase IKB (IKK) e a translocação do NF-kβ .small[(Bhattacharyya & Law, 2022; Kumar et al., 2005)].
  - Redução de edema, inibição de NO e PGE2 .small[(Tewtrakul et al., 2011)].
  - Efeitos positivos em modelos animais de dermatite atópica .small[(Kang et al., 2022)].

- .my-coral[**Atividades Anti-hiperlipemiantes e Metabólicas**]
  - Inibe a DGAT, reduzindo a síntese de triglicerídeos .small[(Timalsina & Devkota, 2021)]
  - Inibe tirosina fosfatase 1B - “begeamento” do tecido adiposo, melhorando a sensibilidade à insulina .small[(Le et al., 2021; Yao et al., 2022; Gupta et al., 2017; Gupta et al., 2018)].

- .my-coral[**Atividade Ansiolítica**]
  - Estudos em modelos animais indicam redução da agressividade e melhora em respostas relacionadas à ansiedade .small[(Banji et al., 2010; Lobo & Manavalan, 2008)].
...
**.my-coral[Contraindicações]** <br/>
Não é recomendada para gestantes, lactentes e em casos de diarreia crônica 
<br/>.small[(Pereira et al., 2020a; Germosén-Robineau, 2005)].

**.my-coral[Toxicidade]** <br/>
Estudos em animais (ratos e camundongos) não apontaram sinais de toxicidade até 2000 mg/kg <br/>.small[(Yadav et al., 2017; Singh et al., 1993; Banji et al., 2010)].

**.my-coral[Dose clínica]** <br/> 
A dose inicial para ensaios em humanos pode ser estimada a partir dos modelos animais 
<br/>.small[(FDA, 2005)].
