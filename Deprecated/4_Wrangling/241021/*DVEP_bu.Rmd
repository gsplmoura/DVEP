...
setwd("/Users/gustavosplmoura/Library/Mobile Documents/com~apple~CloudDocs/Medicina/Biblioteca/Research/Data Science/Data Science/DVEP/Git")
...
```{r}
## Saving the output of describe(data) to a text file
writeLines(capture.output(describe(data)), "factors.txt")
```