...
- Considerar remoção de variáveis com p > 0.5 e sem base teórica.
- Avaliar o impacto de variáveis correlacionadas (e.g., `bmi`, `abdomen`).
- Testar modelos reduzidos orientados por AIC ou p-valor.
